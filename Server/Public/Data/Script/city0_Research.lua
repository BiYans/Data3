...
x805026_g_Name	="ÐÕi T±ng Quän Bang Hµi"
...
x805026_g_SignPost = {x = 109, z = 167, tip = "ÐÕi T±ng Quän Bang Hµi"}
...
function x805026_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø#W: Thång c¤p nghiên cÑu",MSG2PLAYER_PARA )
...
function x805026_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x805026_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
			...
			if ret > 0 then
				...
				Msg2Player(  sceneId, selfId,"#YNhi®m vø hoàn thành#W: Thång c¤p nghiên cÑu",MSG2PLAYER_PARA )
