...
x806003_g_eventId_marry = 0;				-- ÎÒÏë½á»étoÕ ðµ ÊÂ¼þID
x806003_g_eventId_selectLevel1 = 1;			-- Ñ¡Ôñmµt °ã¹æÄ£»éÀñtoÕ ðµ ÊÂ¼þID
x806003_g_eventId_selectLevel2 = 2;			-- Ñ¡ÔñÖÐµÈ¹æÄ£»éÀñtoÕ ðµ ÊÂ¼þID
x806003_g_eventId_selectLevel3 = 3;			-- Ñ¡ÔñºÀ»ª¹æÄ£»éÀñtoÕ ðµ ÊÂ¼þID
x806003_g_eventId_selectLevelCancel = 4;	-- HuÖ böÑ¡Ôñ»éÀñ¹æÄ£toÕ ðµ ÊÂ¼þID
x806003_g_eventId_selfAcceptLevel1 = 5;		-- ×ÔÒÑXác nh§nÁËÑ¡Ôñmµt °ã¹æÄ£»éÀñ
x806003_g_eventId_selfAcceptLevel2 = 6;		-- ×ÔÒÑXác nh§nÁËÑ¡ÔñÖÐµÈ¹æÄ£»éÀñ
x806003_g_eventId_selfAcceptLevel3 = 7;		-- ×ÔÒÑXác nh§nÁËÑ¡ÔñºÀ»ª¹æÄ£»éÀñ
x806003_g_eventId_selfCancelLevel = 8;		-- ×ÔÒÑHuÖ böÁËÑ¡Ôñ»éÀñ¹æÄ£
x806003_g_eventId_targetAcceptLevel1 = 9;	-- ¶Ô·½Xác nh§nÁËÑ¡Ôñmµt °ã¹æÄ£»éÀñ
x806003_g_eventId_targetAcceptLevel2 = 10;	-- ¶Ô·½Xác nh§nÁËÑ¡ÔñÖÐµÈ¹æÄ£»éÀñ
x806003_g_eventId_targetAcceptLevel3 = 11;	-- ¶Ô·½Xác nh§nÁËÑ¡ÔñºÀ»ª¹æÄ£»éÀñ
x806003_g_eventId_targetCancelLevel = 12;	-- ¶Ô·½HuÖ böÁËÑ¡Ôñ»éÀñ¹æÄ£
x806003_g_eventId_end = 13;					-- ½áÊøÓï

x806003_g_ticketItemId = 30505079;			-- ¸ßc¤p»éÀñÈ¯ID
x806003_g_ticketItemId2 = 30505106;			-- ÖÐc¤p»éÀñÈ¯ID
...
--**********************************
--¼ì²âÐúng·ñThöa mãnÓÚ½á»étoÕ ðµ Ìõ¼þ
--**********************************
...
function x806003_SelfCheckSelectMarryLevel(sceneId, selfId, targetId, marryLevel)
	...
	BeginEvent(sceneId);
		if marryLevel == 2 then
			AddText(sceneId, "Các hÕ ðã ch÷n r°i "..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i các hÕ s¨ phäi trä #Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#Who£c#{_MONEY"..x806003_CalcNeedMoney(marryLevel).."}, #r#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
		else
			AddText(sceneId, "Các hÕ ðã ch÷n r°i "..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i các hÕ s¨ phäi trä #Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#W ho£c#Y"..GetItemName(sceneId, x806003_g_ticketItemId2).."#Who£c#{_MONEY"..x806003_CalcNeedMoney(marryLevel).."}, #r#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
		end
...
--**********************************
-- ×ÔÒÑÒÑ¾­È·ÈÏÁËCüa ngß½i Ñ¡ÔñtoÕ ðµ ÊÂ¼þ
--**********************************
...
function x806003_TargetCheckSelectMarryLevel(sceneId, selfId, targetId, marryLevel)
	...
	if marryTargetId ~= -1 then
		...
		BeginEvent(sceneId);
			if marryLevel == 2 then
				AddText(sceneId, "Ð¯i phß½ng ðã ch÷n xong"..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i ð¯i phß½ng s¨ phäi trä#Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#Who£c#{_MONEY"..x806003_CalcNeedMoney(marryLevel).."}, #r#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
			else
				AddText(sceneId, "Ð¯i phß½ng ðã ch÷n xong"..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i ð¯i phß½ng s¨ phäi trä#Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#W ho£c#Y"..GetItemName(sceneId, x806003_g_ticketItemId2).."#Who£c#{_MONEY"..x806003_CalcNeedMoney(marryLevel).."}, #r#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
			end
...
--**********************************
-- ¶Ô·½ÒÑ¾­È·ÈÏÁËCüa ngß½i Ñ¡ÔñtoÕ ðµ ÊÂ¼þ
--**********************************
...
--**********************************
-- ¶Ô·½ÒÑ¾­HuÖ böÁËCüa ngß½i Ñ¡ÔñtoÕ ðµ ÊÂ¼þ
--**********************************
...
function x806003_DoMarry(sceneId, selfId, targetId, marryLevel, maleId, femaleId)
	...
	--ÁÄÌì´°¿Ú¸øÄÐ·½ÌáÊ¾
	--Msg2Player(sceneId, maleId, "Chúc m×ngÄãºÍ"..femaleName.."½áÎª·òÆÞ!", MSG2PLAYER_PARA);
	Msg2Player(sceneId, maleId, "Các hÕ ðÕt thêm danh xßng \'"..femaleName.."Phu quân cüa \'", MSG2PLAYER_PARA);

	--ÁÄÌì´°¿Ú¸øÅ®·½ÌáÊ¾
	--Msg2Player(sceneId, femaleId, "Chúc m×ngÄãºÍ"..maleName.."½áÎª·òÆÞ!", MSG2PLAYER_PARA);
	...
	--·Ö±ð·¢EMAIL¸øÄÐÅ®Ë«·½ÉÏÃætoÕ ðµ ËùÓÐºÃÓÑ
	local maleGuid = LuaFnGetGUID(sceneId, maleId);
	local femaleGuid = LuaFnGetGUID(sceneId, femaleId);
...
--**********************************
-- ði¬m»éÀñµÈc¤p¶ÔÓ¦toÕ ðµ ½äÖ¸toÕ ðµ ID
--**********************************
