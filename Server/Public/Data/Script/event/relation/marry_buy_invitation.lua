...
x806017_g_invitationDataId_level2  = 30303101;		-- ¸ßc¤pÇëÌûID
...
--||++--¹ºÂòcáiÊý(1,5,10)
--|+----¹ºÂòµÈc¤p(0,1,2)
--+-----²Ëµ¥ID(0=Ë¢ÐÂÁÐ±í,1=Ñ¡ÔñµÈc¤p,2=Ñ¡ÔñcáiÊý,3=Ðúng·ñXác nh§n)

x806017_g_eventId_update = 0;			--Ë¢ÐÂÁÐ±í
x806017_g_eventId_cancel = 1;			--¹Ø±Õ
x806017_g_eventId_select_level = 1000;	--Ñ¡ÔñµÈc¤p
x806017_g_eventId_select_count = 2000;	--Ñ¡ÔñcáiÊý
x806017_g_eventId_select_buy = 3000;	--Ðúng·ñXác nh§n

--x806017_g_eventId_update = 0;				-- ¹ºÂòÇëÌû
--x806017_g_eventId_level_0 = 1000;			-- ÆÕÍ¨ÇëÌû
--x806017_g_eventId_level_1 = 1100;			-- ¸ßc¤pÇëÌû
--x806017_g_eventId_level_2 = 1200;			-- ºÀ»ªÇëÌû

--x806017_g_eventId_count_0_1 = 2001;		-- ¹ºÂòmµt ÕÅÆÕÍ¨ÇëÌû
--x806017_g_eventId_count_0_5 = 2005;		-- ¹ºÂòÎåÕÅÆÕÍ¨ÇëÌû
--x806017_g_eventId_count_0_10 = 2010;		-- ¹ºÂòÊ®ÕÅÆÕÍ¨ÇëÌû
					   
--x806017_g_eventId_count_1_1 = 2101;		-- ¹ºÂòmµt ÕÅ¸ßc¤pÇëÌû
--x806017_g_eventId_count_1_5 = 2105;		-- ¹ºÂòÎåÕÅ¸ßc¤pÇëÌû
--x806017_g_eventId_count_1_10 = 2110;		-- ¹ºÂòÊ®ÕÅ¸ßc¤pÇëÌû
					   
--x806017_g_eventId_count_2_1 = 2201;		-- ¹ºÂòmµt ÕÅºÀ»ªÇëÌû
--x806017_g_eventId_count_2_5 = 2205;		-- ¹ºÂòÎåÕÅºÀ»ªÇëÌû
--x806017_g_eventId_count_2_10 = 2210;		-- ¹ºÂòÊ®ÕÅºÀ»ªÇëÌû

--x806017_g_eventId_buy_0_1 = 3001;			-- ¹ºÂòmµt ÕÅÆÕÍ¨ÇëÌû
--x806017_g_eventId_buy_0_5 = 3005;			-- ¹ºÂòÎåÕÅÆÕÍ¨ÇëÌû
--x806017_g_eventId_buy_0_10 = 3010;		-- ¹ºÂòÊ®ÕÅÆÕÍ¨ÇëÌû
					  
--x806017_g_eventId_buy_1_1 = 3101;			-- ¹ºÂòmµt ÕÅ¸ßc¤pÇëÌû
--x806017_g_eventId_buy_1_5 = 3105;			-- ¹ºÂòÎåÕÅ¸ßc¤pÇëÌû
--x806017_g_eventId_buy_1_10 = 3110;		-- ¹ºÂòÊ®ÕÅ¸ßc¤pÇëÌû
					  
--x806017_g_eventId_buy_2_1 = 3201;			-- ¹ºÂòmµt ÕÅºÀ»ªÇëÌû
...
--**********************************
--Ë¢ÐÂ¹ºÂòÇëÌûtoÕ ðµ µÈc¤pÁÐ±ítoÕ ðµ ÊÂ¼þ
--**********************************
...
--**********************************
--Ñ¡ÔñÇëÌûtoÕ ðµ µÈc¤ptoÕ ðµ ÊÂ¼þ
--**********************************
...
--**********************************
--Ñ¡ÔñÇëÌûtoÕ ðµ ÊýÁ¿toÕ ðµ ÊÂ¼þ
--**********************************
