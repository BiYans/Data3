...
x401000_g_LimitMembers=3			--¿ÉÒÔ½ø¸±±¾toÕ ğµ ×îĞ¡¶ÓÎéÈËÊı
...
function x401000_CheckTeamLeader( sceneId, selfId )
	...
	if	nearteammembercount<x401000_g_LimitMembers	then
		BeginEvent(sceneId)
	  		AddText(sceneId,"Tham gia Trân Long KÏ Cuµc yêu c¥u ğµi ngû phäi có "..x401000_g_LimitMembers.." thành viên tr· lên.");
	  	EndEvent(sceneId)
		DispatchMissionTips(sceneId,selfId)
		return	 0
	end
