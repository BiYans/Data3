...
x401001_g_limitMembers = 3;					--¿ÉÒÔ½ø¸±±¾toÕ ðµ ×îÐ¡¶ÓÎéÈËÊý
...
function x401001_CheckAndEnterScene(sceneId, selfId, targetId, eventId)
	...
	if FbTime ~= 0 then
		if x401001_enumerate == eventId then
			...
			x401001_NotifyFailTips( sceneId, selfId, "Còn "..FbTime.." phút næa máy chü s¨ tiªn hành bäo trì, các phø bän ðã ðóng." )
		end
		return
	end
	...
	strOutmsg = "Tham gia hoÕt ðµng ch½i c¶ c¥n có "..Fb1.." Ngß¶i ho£c Ðµi có "..Fb1.." Ngß¶i tr· lên m¾i có th¬ tham gia. Nhóm cüa các hÕ không ðü ngß¶i";
	...
	if GetLevel(sceneId, selfId) < Fb2 then
		if x401001_enumerate == eventId then
			AddText( sceneId, "Ngß¶i ch½i có ðÆng c¤p trên "..Fb2.." có th¬ tham gia hoÕt ðµng kÏ cuµc, Thành viên trong ðµi ngû cüa các hÕ chßa ðÕt ðªn c¤p "..Fb2.."." )
		else
			x401001_NotifyFailTips(sceneId, selfId, "Ngß¶i ch½i có ðÆng c¤p trên "..Fb2.." có th¬ tham gia hoÕt ðµng kÏ cuµc, Thành viên trong ðµi ngû cüa các hÕ chßa ðÕt ðªn c¤p "..Fb2..".");
		end
		return 0
	end
	...
	if nLowLvlCnt > 0 then
		local msgstr = "Ngß¶i ch½i có ðÆng c¤p trên "..Fb2.." có th¬ tham gia hoÕt ðµng kÏ cuµc, Thành viên trong ðµi ngû cüa các hÕ có ( "..memNameList.." ) ÐÆng c¤p không ðü c¤p "..Fb2.."."
		if x401001_enumerate == eventId then
