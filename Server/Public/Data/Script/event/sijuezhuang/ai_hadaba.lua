...
function x893064_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#{_INFOUSR%s}#cff99cc th¯ng lînh ðµi ngû ðªn TÑ Tuy®t Trang cu¯i cùng träm hÕ #Y[Mçn M£c]#W#cff99cc té xu¯ng ngña!", playerName); --ÎÚÀÏ´ó
...
function x893064_UseSkillD( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Mçn M£c", "TÑ Tuy®t Trang", "Nhân sinh ð¡c ý tu tçn hoan, mÕc khiªn tim tôn ð¯i không nguy®t." )

	CallScriptFunction((200060), "Paopao",sceneId, "Mçn M£c", "TÑ Tuy®t Trang","Tr¶i sinh ta tài t¤t có ð¤t dùng, thiên kim tan hªt hoàn phøc lÕi." )

	CallScriptFunction((200060), "Paopao",sceneId, "Phan Tinh Tinh", "TÑ Tuy®t Trang","Mçn M£c s¡p thi tri¬n tuy®t kÛ r°i, m÷i ngß¶i hãy tránh xa các cÕm bçy cüa h¡n!" )
