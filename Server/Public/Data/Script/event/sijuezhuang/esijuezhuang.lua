...
x893063_g_BOSSList =
{
	["MinMo_NPC"]				= { DataID=14100, Title="", posX=96, posY=79, Dir=18, BaseAI=3, AIScript=0, ScriptID=893070 },
	["MinMo_BOSS"]				= { DataID=14106, Title="", posX=100, posY=90, Dir=0, BaseAI=27, AIScript=0, ScriptID=893064 },

	["QinYun_NPC"]		= { DataID=14100, Title="", posX=83, posY=23, Dir=18, BaseAI=3, AIScript=0, ScriptID=893071 },
	["QinYun_BOSS"]		= { DataID=14132, Title="", posX=102, posY=34, Dir=0, BaseAI=27, AIScript=0, ScriptID=893065 },
	...
	["TaoQin_BOSS"]			= { DataID=14125, Title="", posX=29, posY=100, Dir=11, BaseAI=27, AIScript=0, ScriptID=893066 },
	...
	["PangQi_BOSS"]		= { DataID=14145, Title="", posX=30, posY=29, Dir=27, BaseAI=27, AIScript=0, ScriptID=893069 },

	["Panqinqin_NPC"]				= { DataID=60, Title="", posX=101, posY=111, Dir=18, BaseAI=3, AIScript=0, ScriptID=893080 },
	["Zhong_NPC"]				= { DataID=14119, Title="Xao Chung", posX=100, posY=82, Dir=0, BaseAI=3, AIScript=0, ScriptID=893081 },
...
function x893063_OnDefaultEvent( sceneId, selfId, targetId )
	...
	--BroadMsgByChatPipe( sceneId, selfId, ""..nam.." #W#cff99cccùng ðµi ngû tiªn vào TÑ Tuy®t Trang ðánh bÕi Bàng Xí d©p loÕn ân oán TÑ Tuy®t Trang.", 4 )
...
function x893063_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x893063_g_ScriptId, "Ân oán TÑ Tuy®t Trang", 10, 1 )
...
function x893063_CheckCanEnter( sceneId, selfId, targetId )
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. " ngày hôm nay ðã khiêu chiªn quá 4 l¥n TÑ Tuy®t Trang"
		return 0, msg
