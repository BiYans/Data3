...
--ÃâÒßÌØ¶¨¼¼ÄÜbuff....
x893069_Buff_MianYi1	= 10472	--ÃâÒßÒ»Ð©¸ºÃæÐ§¹û....
x893069_Buff_MianYi2	= 10471	--ÃâÒßÆÕÍ¨ÒþÉí....
...
{
	"Các ngß½i c¦n th§n, ta ðã tri®u h°i Long Trø!",
	"Các ngß½i c¦n th§n, ta ðã tri®u h°i Long Trø!",
	"Các ngß½i c¦n th§n, ta ðã tri®u h°i Long Trø!",
	"Các ngß½i c¦n th§n, ta ðã tri®u h°i Long Trø!",
	"Các ngß½i c¦n th§n, ta ðã tri®u h°i Long Trø!"
...
x893069_SkillB_Text =
{
	"Phan Tinh Tinh: Chú ý, #GBàng Xí#W ðã tri®u t§p #GLong Trø: Mµc#W, mau mau kh¡c chª #GLong Trø: Mµc#W b¢ng #GLong Trø: Kim#W bên cÕnh ði, nªu không e r¢ng không ai có th¬ toàn mÕng cä!",
	"Phan Tinh Tinh: Chú ý, #GBàng Xí#W ðã tri®u t§p #GLong Trø: Th±#W, mau mau kh¡c chª #GLong Trø: Th±#W b¢ng #GLong Trø: Mµc#W bên cÕnh ði, nªu không e r¢ng không ai có th¬ toàn mÕng cä!",
	"Phan Tinh Tinh: Chú ý, #GBàng Xí#W ðã tri®u t§p #GLong Trø: Höa#W, mau mau kh¡c chª #GLong Trø: Höa#W b¢ng #GLong Trø: Thüy#W bên cÕnh ði, nªu không e r¢ng không ai có th¬ toàn mÕng cä!",
	"Phan Tinh Tinh: Chú ý, #GBàng Xí#W ðã tri®u t§p #GLong Trø: Kim#W, mau mau kh¡c chª #GLong Trø: Kim#W b¢ng #GLong Trø: Höa#W bên cÕnh ði, nªu không e r¢ng không ai có th¬ toàn mÕng cä!",
	"Phan Tinh Tinh: Chú ý, #GBàng Xí#W ðã tri®u t§p #GLong Trø: Thüy#W, mau mau kh¡c chª #GLong Trø: Thüy#W b¢ng #GLong Trø: Th±#W bên cÕnh ði, nªu không e r¢ng không ai có th¬ toàn mÕng cä!"
}
...
x893069_LootItem_1 = {
--39999901,39999902,39999903,39999904,39999905,39999906,30700243,39910004,
}
x893069_LootItem_2 = {
...
function x893069_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format(" #Y[Bàng Xí]#W#cff99cc dùng ð¬ bí bäo chiªm TÑ Tuy®t Trang, chÆng nhæng b¸ #{_INFOUSR%s}#cff99cc cùng ðµi ngû phá hüy mà bän thân Bàng Xí cûng không giæ n±i tính mÕng cüa mình!", playerName); --ÀîÇïË®
...
function x893069_TickSkillB( sceneId, selfId, nTick )
	...
	elseif CurStep > LastStep and CurStep < 4 then
		...
		CallScriptFunction((200060), "Paopao",sceneId, "Phan Tinh Tinh", "TÑ Tuy®t Trang", "Phäi nhanh tay ðánh chªt tinh la ti¬u tØ, nªu không Bàng Xí s¨ phøc h°i tr· lÕi, lúc ðó e r¢ng ta cûng chÆng ðßþc bình yên ra khöi n½i này næa ðâu...")
	...
	--Ê¹ÓÃ¿Õ¼¼ÄÜ....
		...
		CallScriptFunction((200060), "Paopao",sceneId, "Phan Tinh Tinh", "TÑ Tuy®t Trang", "Bàng Xí liên tøc phóng th§p ðÕi nh¤t cß¾c, m÷i ngß¶i chú ý coi ch×ng cÕm bçy dß¾i trân mình ðó...")
