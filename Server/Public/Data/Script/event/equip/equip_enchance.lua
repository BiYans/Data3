...
function x809262_FinishEnhance( sceneId, selfId, itemidx1, itemidx2 )
	...
	local LongWenID = LuaFnGetItemTableIndexByIndex( sceneId, selfId, itemidx1 )
	if LongWenID >= 10160001 and LongWenID <= 10168900 then
		ret = 0;
	end
	if LongWenID >= 10169001 and LongWenID <= 10169900 then
		ret = -4;
	end
...
function x809262_DoFinishEnhance( sceneId, selfId, index )
	...
	local LongWenID = LuaFnGetItemTableIndexByIndex( sceneId, selfId, itemidx1)
	if LongWenID >= 10160001 and LongWenID <= 10168900 then
		LuaFnEquipLevelUp(sceneId,selfId,itemidx1,itemidx1)
