...
--ÈÎÎñÎÄ±¾ÃèÊö
x400964_g_MissionName="Ði Ðào Hoa Ðäo"		-- È¥Thánh Thú S½n
x400964_g_MissionInfo="Ði Hoa Ðäo."  		-- ÈÎÎñÃèÊö
x400964_g_MissionTarget="Ði Hoa Ðäo"		-- Møc tiêu nhi®m vø
x400964_g_ContinueInfo="Ði Hoa Ðäo"			-- Î´Hoàn t¤t nhi®m vøtoÕ ðµ npc¶Ô»°
x400964_g_MissionComplete="Ði Hoa Ðäo"	-- Hoàn t¤t nhi®m vønpcËµ»°toÕ ðµ »°
...
function x400964_OnDefaultEvent( sceneId, selfId, targetId )	-- ði¬m»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
	...
	BeginUICommand(sceneId)
			...
			UICommand_AddString(sceneId, "Ðào Hoa Ðäo là khu vñc không tång sát khí, hãy chú ý an toàn. B¢ng hæu xác nh§n tiªn vào hay không?");	
...
function x400964_GotoShengShouShan( sceneId, selfId, targetId )
	...
	CallScriptFunction((400900), "TransferFuncFromNpc", sceneId, selfId, 411, 30, 30, 21 );
	return
