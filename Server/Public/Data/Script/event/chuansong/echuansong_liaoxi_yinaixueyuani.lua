...
function x400925_OnEnterArea( sceneId, selfId )
    ...
    BeginUICommand(sceneId)
		...
		UICommand_AddString(sceneId, "#cfff263Ngân Ngai Tuyªt Nguyên cho phép tuyên chiªn, #Gkhông sát khí#cfff263, có th¬ xäy ra #GPK#cfff263. Chú ý bäo tr÷ng.#r    #cfff263 Trong khu vñc này #Gchü ðµng t¤n công#cfff263 ngß¶i ch½i khác#G không b¸ tr×ng phÕt#cfff263.#r    #cfff263Có mu¯n vào không?");
