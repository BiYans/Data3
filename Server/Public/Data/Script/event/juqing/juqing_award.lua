...
x200099_NpcInfo={{id=1,name="Mµc Uy¬n Thanh",	mis=8,	p1=92, m1=MD_JU_XUNHUAN_MUWANQING,	m2=MD_JU_XUNHUAN_MUWANQING_1, 	b1=7917, b2=7918, b3=7919, b4=7920},
								 {id=2,name="Chung Linh",	mis=8,		p1=93, m1=MD_JU_XUNHUAN_ZHONGLING,	m2=MD_JU_XUNHUAN_ZHONGLING_1, 	b1=7921, b2=7922, b3=7923, b4=7924},
								 {id=3,name="Ðoàn Diên Khánh",	mis=8,	p1=94, m1=MD_JU_XUNHUAN_DUANYANQING,m2=MD_JU_XUNHUAN_DUANYANQING_1, b1=-1, b2=7926, b3=7927, b4=7928},
								 {id=4,name="Ðoàn Chính Thu¥n",	mis=8,	p1=95, m1=MD_JU_XUNHUAN_DUANYU,			m2=MD_JU_XUNHUAN_DUANYU_1, 			b1=-1, b2=7930, b3=7931, b4=7932},
								 {id=5,name="Nguy­n Tinh Trúc",	mis=15,	p1=96, m1=MD_JU_XUNHUAN_AZHU,				m2=MD_JU_XUNHUAN_AZHU_1,				b1=-1, b2=7934, b3=7935, b4=7936},
								 {id=6,name="A Bích",	mis=15,		p1=97, m1=MD_JU_XUNHUAN_ABI,				m2=MD_JU_XUNHUAN_ABI_1, 				b1=7937, b2=7938, b3=7939, b4=7940},
								 {id=7,name="Vß½ng phu nhân",	mis=15,	p1=98, m1=MD_JU_XUNHUAN_WANGYUYAN,	m2=MD_JU_XUNHUAN_WANGYUYAN_1, 	b1=-1, b2=-1, b3=7943, b4=7944},
								 {id=8,name="Gia Lu§t ÐÕi ThÕch",	mis=23,	p1=99, m1=MD_JU_XUNHUAN_XIAOFENG,		m2=MD_JU_XUNHUAN_XIAOFENG_1, 		b1=-1, b2=-1, b3=7947, b4=7948},
								 {id=9,name="A TØ",	mis=32,		p1=100, m1=MD_JU_XUNHUAN_AZI,				m2=MD_JU_XUNHUAN_AZI_1, 				b1=-1, b2=7950, b3=7951, b3=7952},
								 {id=10,name="Mµ Dung Phøc",	mis=37,	p1=101, m1=MD_JU_XUNHUAN_MURONGFU,	m2=MD_JU_XUNHUAN_MURONGFU_1, 		b1=-1, b2=-1, b3=7955, b4=7956},
								 {id=11,name="Di®p Nh¸ Nß½ng",	mis=37,	p1=102, m1=MD_JU_XUNHUAN_XUZHU,			m2=MD_JU_XUNHUAN_XUZHU_1, 			b1=-1, b2=-1, b3=-1, b4=7960},
								 {id=12,name="Cßu Ma Trí",	mis=37,	p1=103, m1=MD_JU_XUNHUAN_JIUMOZHI,	m2=MD_JU_XUNHUAN_JIUMOZHI_1, 		b1=-1, b2=7962, b3=7963, b4=7964},
								 {id=13,name="Hách Liên Thiªt Thø",	mis=45,	p1=104, m1=MD_JU_XUNHUAN_YINCHUAN,	m2=MD_JU_XUNHUAN_YINCHUAN_1, 		b1=-1, b2=7966, b3=7967, b4=7968}
								}
...
function x200099_OnEnumerate( sceneId, selfId, targetId )
	...
	if (IsMissionHaveDone(sceneId,selfId,x200099_NpcInfo[nIndex].mis) > 0 ) then
		AddNumText( sceneId, x200099_g_ScriptId, "Trò chuy®n", 0, 1 )
	end
