...
x210538_g_scriptId = 210538


--所拥有的事件ID列表用ID集合实现
x210538_g_LimitiBuffCollectionID = 75;

--终极武器，50%掉落随机 1 件
x210538_g_LootItem_3 = {
30505278,30505279,30505280,
}

--15级宝石，100%掉落随机 1 件
x210538_g_LootItem_2 = {
...
--事件列表
--**********************************
function x210538_OnDefaultEvent( sceneId, selfId, targetId )
...
--特殊交互:条件判断
--**********************************
function x210538_OnActivateConditionCheck( sceneId, selfId, activatorId )
	-- 限制身上的buff
	local bOk = x210538_IsCanOpenBox( sceneId,activatorId )
	...
	LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, activatorId, x210538_g_BuffId_3, 0);
	LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, activatorId, x210538_g_BuffId_4, 0);
...
--**********************************
function x210538_IsCanOpenBox( sceneId,activatorId )
	
	if LuaFnHaveImpactOfSpecificDataIndex(sceneId,activatorId, x210538_g_BuffId_2)==1  then
		return 0
	end

	return 0==LuaFnHaveImpactInSpecificCollection(sceneId, activatorId, x210538_g_LimitiBuffCollectionID)
end

--**********************************
--特殊交互:消耗和扣除处理
--**********************************
function x210538_OnActivateDeplete( sceneId, selfId, activatorId )
	return 1
end
...
--特殊交互:聚气类成功生效处理
--**********************************
function x210538_OnActivateEffectOnce( sceneId, selfId, activatorId )
	...
	if random(1000) <= 900  then
		nItemCount = 3
		nItemId_1 = x210538_g_LootItem_1[random( getn(x210538_g_LootItem_1))]
	end

	if random(1000) <= 50  then
		nItemCount = 4
	       nItemId_3 = x210538_g_LootItem_3[random( getn(x210538_g_LootItem_3) )]
	end	

	if random(1000) <= 150  then
		nItemCount = 5
	       nItemId_6 = x210538_g_LootItem_4[random( getn(x210534_g_LootItem_4) )]
	end

	nItemId_2 = x210538_g_LootItem_2[random( getn(x210538_g_LootItem_2) )]
	nItemId_4 = x210538_g_LootItem_2[random( getn(x210538_g_LootItem_2) )]
	nItemId_5 = x210538_g_LootItem_5[random( getn(x210538_g_LootItem_5) )]
	...
	LuaFnSendSpecificImpactToUnit(sceneId, activatorId, activatorId, 
										activatorId, x210538_g_BuffId_1, 100 )
	
	LuaFnSendSpecificImpactToUnit(sceneId, activatorId, activatorId, 
										activatorId, x210538_g_BuffId_2, 100 )
										
	x210538_DealExp(sceneId, activatorId)
...
--特殊交互:引导类每时间间隔生效处理
--**********************************
function x210538_OnActivateEffectEachTick( sceneId, selfId, activatorId )
	return 1
end
...
--特殊交互:交互开始时的特殊处理
--**********************************
function x210538_OnActivateActionStart( sceneId, selfId, activatorId )
	--PrintNum(777)
	return 1
end
...
--特殊交互:交互撤消时的特殊处理
--**********************************
function x210538_OnActivateCancel( sceneId, selfId, activatorId )
...
--特殊交互:交互中断时的特殊处理
--**********************************
function x210538_OnActivateInterrupt( sceneId, selfId, activatorId )
...
function x210538_DealExp(sceneId, activatorId)
