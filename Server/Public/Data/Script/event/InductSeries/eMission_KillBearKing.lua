...
--ÅÜÅÜÒıµ¼ÈÎÎñ2_¸ÉµôH°ng Hùng Vß½ng
...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x500610_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»

--ÈÎÎñÎÄ±¾ÃèÊö
x500610_g_MissionName			= "XØ lı H°ng Hùng Vß½ng"
--ÈÎÎñÃèÊö
...
--ÈÎÎñĞúng·ñÍê³É
x500610_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--Ğúng·ñÉ±¹ÖtoÕ ğµ ±ê¼Ç
x500610_g_RecordIdx 				 = 1		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ1Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x500610_g_MissScriptID_Idx	 = 2		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ2Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x500610_g_AcceptNPC_Idx			 = 3		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ3Î» 2.Tô ChâuNPC
...
x500610_g_PlayerSlow_LVL					 = 38		-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x500610_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x500610_g_AcceptMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500610_g_Name then
			x500610_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- ÈÎÎñĞúng·ñÒÑÂú
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x500610_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
