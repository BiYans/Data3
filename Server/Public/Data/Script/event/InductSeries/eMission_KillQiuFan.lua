...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x500618_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
...
--ÈÎÎñĞúng·ñÍê³É
x500618_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--Ğúng·ñÉ±¹ÖtoÕ ğµ ±ê¼Ç
x500618_g_RecordIdx 				 = 1		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ1Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x500618_g_MissScriptID_Idx	 = 2		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ2Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x500618_g_AcceptNPC_Idx			 = 3		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ3Î» 2.Tô ChâuNPC
...
x500618_g_PlayerSlow_LVL					 = 45		-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x500618_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x500618_g_AcceptMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500618_g_Name then
			x500618_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- ÈÎÎñĞúng·ñÒÑÂú
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x500618_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
