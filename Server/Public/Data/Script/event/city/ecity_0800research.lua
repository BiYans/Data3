...
function x600040_ListQ_Clicked( sceneId, selfId, targetId, eventId )
	CallScriptFunction( x600040_g_CityMissionScript, "DoDefaultEvent", sceneId, selfId, targetId, x600030_g_MissionId, eventId )
end
