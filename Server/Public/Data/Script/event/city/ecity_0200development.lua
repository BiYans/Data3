...
function x600007_ListQ_Clicked( sceneId, selfId, targetId, eventId )
	CallScriptFunction( x600007_g_CityMissionScript, "DoDefaultEvent", sceneId, selfId, targetId, x600030_g_MissionId, eventId )
end
--**********************************
--ÁĞ¾ÙÊÂ¼ş
--**********************************
