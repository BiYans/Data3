...
function x889071_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText( sceneId, "  #Y装备#W打孔#G(#cFF0000强化#G)数，#G如不满意，#cFF0000一直点击#Y打孔#G(#cFF0000强化#G),#W一直到您满意为止" )
	AddText(sceneId,"   #G本服务器已开通#cFF0000坐骑打孔#W和#cFF0000镶嵌 ")	
	AddText(sceneId,"   #Y暗器#G.#Y武魂#G.#Y时装#G请在#cFF0000网站打孔#Y后到游戏中#G镶嵌！")	
	...
	AddNumText( sceneId, x889071_g_scriptId, "#gffff00#Y一键#W打孔", 2, 100)
...
function x889071_OnEventRequest( sceneId, selfId, targetId, eventId )
	if GetNumText() == 200 then
		...
		for i=bagbegin, bagend do
	       ...
	       x889071_NotifyTip( sceneId, selfId, "包裹150级以下所有装备已成功强化 1 次。" )
