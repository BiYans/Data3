...
function x510531_OnEventRequest( sceneId, selfId, targetId, eventId)
	...
	elseif GetNumText() == 101 then
		BeginEvent( sceneId )
			...
			AddNumText( sceneId, x510531_g_scriptId, "#G大衍天玄", 10, 1011)
			AddNumText( sceneId, x510531_g_scriptId, "#G倚天长生", 10, 1012)
			AddNumText( sceneId, x510531_g_scriptId, "#G洪荒龙舞", 10, 1013)
			AddNumText( sceneId, x510531_g_scriptId, "#G万世枯荣", 10, 1014)
			AddNumText( sceneId, x510531_g_scriptId, "#G六道黄泉", 10, 1015)
			AddNumText( sceneId, x510531_g_scriptId, "#G无相绝踪", 10, 1016)
			AddNumText( sceneId, x510531_g_scriptId, "#G达摩一叹", 10, 1017)
			AddNumText( sceneId, x510531_g_scriptId, "#G太古飘翎", 10, 1018)
			AddNumText( sceneId, x510531_g_scriptId, "#G末世王权", 10, 1019)
			AddNumText( sceneId, x510531_g_scriptId, "#G九霄焱阳", 10, 1020)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
