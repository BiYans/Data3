...
function x002095_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x002095_g_scriptId, "#G免费领取#Y随身宝石", 5, 1100 )
             AddNumText( sceneId, x002095_g_scriptId, "#cffcc00气血满怒#Y治疗", 5, 860 )
             AddNumText( sceneId, x002095_g_scriptId, "#cff99cc包裹废品#Y清理", 5, 301 )
	      AddNumText( sceneId, x002095_g_ScriptId, "#G全属光环#Y领取",5,840 )
             AddNumText( sceneId, x002095_g_scriptId, "#b#G领取个性#Y称号", 5, 501 )
             AddNumText( sceneId, x002095_g_scriptId, "#cFF0000超级变身#Y有趣", 5, 850 )
             AddNumText( sceneId, x002095_g_ScriptId, "#G特效风火轮#gffff00(加速10%)",5,800 )
             AddNumText( sceneId, x002095_g_ScriptId, "#G特效海之蓝#gffff00(加速10%)",5,810 )
             AddNumText( sceneId, x002095_g_ScriptId, "#G特效子母绿#gffff00(加速10%)",5,820 )
             AddNumText( sceneId, x002095_g_ScriptId, "#G特效胭脂雪#gffff00(加速10%)",5,830 )
	EndEvent( sceneId )
...
function x002095_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	elseif GetNumText() == 301 then
		...
		BeginEvent( sceneId )
			...
			AddNumText( sceneId, x002095_g_ScriptId, "#effc9d8#cf30768确认清理包裹", 5, 302 )
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	elseif GetNumText() == 302 then
		...
		x002095_NotifyFailTips(sceneId, selfId, "#Y一共有#effc9d8#cf30768"..ClearCount.."#Y格装备被清理")
	...
	elseif GetNumText() == 830 then
       ...
       elseif GetNumText() == 850 then
		...
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y兔爷",7,8501 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y玉兔",7,8502 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y黑熊",7,8503 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y灯谜",7,8504 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y圣诞树",7,8505 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y大铃铛",7,8506 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y糖果盒",7,8507 )
		AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y粉红熊",7,8508 )
		--AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y小狐仙",7,8509 )
		--AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y大笨熊",7,8510 )
		--AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y功夫熊猫",7,8511 )
		--AddNumText( sceneId, x002095_g_ScriptId, "#G超级变身#W--#Y超人熊猫",7,8512 )
    	EndEvent( sceneId )
	DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 8512 then
      ...
      elseif GetNumText() == 104 then
       ...
       elseif GetNumText() == 501 then
		...
		AddNumText( sceneId, x002095_g_ScriptId, "免费-哥玩的是寂寞#gff00f0(称号)",7,791 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-哥想把马子#gff00f0(称号)",7,210 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-我是流氓我怕谁#gff00f0(称号)",7,211 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-我就是牛X#gff00f0(称号)",7,212 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-我型我秀#gff00f0(称号)",7,15 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-这个世界哪里有爱情#gff00f0(称号)",7,17 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-天龙财主#gff00f0(称号)",7,18 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-需要爱情#gff00f0(称号)",7,19 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-不服来PK#gff00f0(称号)",7,201 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-我最嚣张#gff00f0(称号)",7,202 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-我是新手！别杀我！#gff00f0(称号)",7,203 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-我是老大#gff00f0(称号)",7,204 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-别装B！装B遭雷劈！#gff00f0(称号)",7,205 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-散人！不打架！#gff00f0(称号)",7,206 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-对不起！我爱你！#gff00f0(称号)",7,207 )
		AddNumText( sceneId, x002095_g_ScriptId, "免费-请不要离开我#gff00f0(称号)",7,208 )
    	EndEvent( sceneId )
	DispatchEventList( sceneId, selfId, targetId )
...
function x002095_lingquyuanbao( sceneId, selfId, targetId )
  ...
  if GetNumText()==80 then
    local index =	GetMissionFlag( sceneId, selfId, MF_LINGQUYUANBAO80 )
      if index == 1 then
        x002095_TalkMsg( sceneId, selfId, targetId, "您已经领取过该项奖励，不能再领了。" )	
        return
      end
    YuanBao(sceneId,selfId,targetId,1,50000)
    SetMissionFlag( sceneId, selfId, MF_LINGQUYUANBAO80, 1 )
    x002095_TalkMsg( sceneId, selfId, targetId, "领取元宝成功，您获得了50000元宝。谢谢你对天龙的支持。" )
  elseif GetNumText()==90 then
    ...
    x002095_TalkMsg( sceneId, selfId, targetId, "领取元宝成功，您获得了100000元宝。谢谢你对天龙的支持。" )
    ...
    x002095_TalkMsg( sceneId, selfId, targetId, "领取元宝成功，您获得了150000元宝。谢谢你对天龙的支持。" )
    elseif GetNumText()==110 then
    ...
    x002095_TalkMsg( sceneId, selfId, targetId, "领取元宝成功，您获得了200000元宝。谢谢你对天龙的支持。" )
    ...
    x002095_TalkMsg( sceneId, selfId, targetId, "领取元宝成功，您获得了300000元宝。谢谢你对天龙的支持。" )
   end
end
