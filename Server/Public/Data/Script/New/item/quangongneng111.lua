...
function x210531_OnEventRequest( sceneId, selfId, targetId, eventId)
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10300005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553126, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553131, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10302005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553136, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553146, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10304005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553151, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553156, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10305005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553161, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553122, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1023 then
	       	local nStoneId0 = 10553126
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553126,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553127, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1024 then
	       	local nStoneId0 = 10553131
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553131,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553132, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1025 then
	       	local nStoneId0 = 10553136
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553136,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553137, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1026 then
	       	local nStoneId0 = 10553146
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553146,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553147, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1027 then
	       	local nStoneId0 = 10553151
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553151,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553152, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1028 then
	       	local nStoneId0 = 10553156
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553156,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553157, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	       	...
	       	local nStoneId0 = 10553161
	       	local nStoneId1 = 30505817
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553161,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553162, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 200 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#G你确定要升级吗？" )
			AddNumText( sceneId, x210531_g_scriptId, "二段#G（#cFF0000LV3-LV5#G）#cFF000070%↑", 5, 201)
	...
	elseif GetNumText() == 201 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#cff99ff灵魂二段精华#W100#cff99ff个" )
		      AddText( sceneId, "#G你确定要升级吗？" )
			AddNumText( sceneId, x210531_g_scriptId, "#G阴·#Y元神禁锢#G（#cFF0000LV3-LV5#G）#cFF000070%↑", 5, 2011)
			AddNumText( sceneId, x210531_g_scriptId, "#G古·#Y灵犀神剑#G（#cFF0000LV3-LV5#G）#cFF000070%↑", 5, 2012)
			AddNumText( sceneId, x210531_g_scriptId, "#G混·#Y逍遥江湖#G（#cFF0000LV3-LV5#G）#cFF000070%↑", 5, 2013)
			AddNumText( sceneId, x210531_g_scriptId, "#G恨·#Y别情离恨#G（#cFF0000LV3-LV5#G）#cFF000070%↑", 5, 2014)
			AddNumText( sceneId, x210531_g_scriptId, "取消", 5, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
