...
function x024001_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
	AddText(sceneId,"  Ngß¶i trë tu±i, · ðây không ðßþc chÕy lung tung! #rNgß¶i r×ng và ngß¶i sói ð«u r¤t ðáng sþ, hãy xem tình hình trong làng, các hÕ s¨ hi¬u b÷n xâm lßþc ðó hung dæ ðªn ðâu.")
	AddText(sceneId,"  Con ðß¶ng l¾n phía trß¾c tên Trà Mã ÐÕo, r¤t nhi«u thß½ng nhân v§n chuy¬n trà ðªn các nß¾c xa xôi, trß¾c ðây ðôi khi cûng có ðµi ngña phi qua làng, tiªng nhÕc ngña có th¬ vang r¤t xa...")
