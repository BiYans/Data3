...
function x034001_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		AddText(sceneId,"R¯t cøc là ai gây ra! Ta nh¤t ð¸nh phäi tìm ra hung thü, ta mu¯n ðem ð¥u h¡n tª vong linh sß phø, sß nß½ng và t¤t cä nhæng ngß¶i cüa Nam Häi kiªm phái!")
		AddText(sceneId,"CØu sß muµi ðáng thß½ng nh¤t, sß muµi nh¤t ð¸nh r¤t ðau lòng... Trong tim nàng ¤y, chï có ðÕi sß huynh.")
