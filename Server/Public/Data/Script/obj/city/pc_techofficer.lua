	...
	BeginEvent( sceneId )
		if Humanguildid == cityguildid then
			...
			if IsHaveMission( sceneId, selfId, 1107 ) > 0 then
				...
				AddNumText( sceneId, x805015_g_scriptId, "#GNhi®m vø KÛ ThuÕt - 600013", 4, 600013 )
				AddNumText( sceneId, x805015_g_scriptId, "#GNhi®m vø KÛ ThuÕt - 600014", 4, 600014 )
				AddNumText( sceneId, x805015_g_scriptId, "#GNhi®m vø KÛ ThuÕt - 600015", 4, 600015 )
				AddNumText( sceneId, x805015_g_scriptId, "#GNhi®m vø KÛ ThuÕt - 600016", 4, 600016 )
			end
