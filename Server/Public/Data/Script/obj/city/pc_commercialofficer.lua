	...
	BeginEvent( sceneId )
		if Humanguildid == cityguildid then
			...
			if IsHaveMission( sceneId, selfId, 1108 ) > 0 then
				...
				AddNumText( sceneId, x805017_g_scriptId, "#GNhi®m vø Thß½ng Nghi®p - 600018", 4, 600018 )
				AddNumText( sceneId, x805017_g_scriptId, "#GNhi®m vø Thß½ng Nghi®p - 600019", 4, 600019 )
				AddNumText( sceneId, x805017_g_scriptId, "#GNhi®m vø Thß½ng Nghi®p - 600020", 4, 600020 )
				AddNumText( sceneId, x805017_g_scriptId, "#GNhi®m vø Thß½ng Nghi®p - 600021", 4, 600021 )
			end
