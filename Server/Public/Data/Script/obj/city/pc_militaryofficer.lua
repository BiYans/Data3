...
function x805028_UpdateEventList( sceneId, selfId, targetId )
	...
	BeginEvent( sceneId )
		...
		--end
		--List Q--
		if IsHaveMission( sceneId, selfId, 1109 ) > 0 then
			CallScriptFunction( 600030, "OnEnumerate", sceneId, selfId, targetId )
		else
			AddNumText( sceneId, x805028_g_scriptId, "#GNhi®m vø Qu¯c Phòng - 600031", 4, 600031 )
			AddNumText( sceneId, x805028_g_scriptId, "#GNhi®m vø Qu¯c Phòng - 600032", 4, 600032 )
			AddNumText( sceneId, x805028_g_scriptId, "#GNhi®m vø Qu¯c Phòng - 600033", 4, 600033 )
			AddNumText( sceneId, x805028_g_scriptId, "#GNhi®m vø Qu¯c Phòng - 600034", 4, 600034 )
		end
		...
		AddNumText( sceneId, x805028_g_scriptId, "Lãnh 1 Ngân Bì L®nh Ti­n", 6, 7 )--[tx43764]
...
function x805028_OnEventRequest( sceneId, selfId, targetId, eventId )
	if GetNumText() >= 600031 and GetNumText() <= 600034 then
		CallScriptFunction(600030, "ListQ_Clicked", sceneId, selfId, targetId, GetNumText())
	end
