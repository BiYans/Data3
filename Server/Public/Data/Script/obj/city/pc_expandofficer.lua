	...
	BeginEvent( sceneId )
		if Humanguildid == cityguildid then
			...
			if IsHaveMission( sceneId, selfId, 1110 ) > 0 then
				...
				AddNumText( sceneId, x805013_g_scriptId, "#GNhi®m vø GKhuªch Trß½ng - 600024", 4, 600024 )
				AddNumText( sceneId, x805013_g_scriptId, "#GNhi®m vø GKhuªch Trß½ng - 600025", 4, 600025 )
				AddNumText( sceneId, x805013_g_scriptId, "#GNhi®m vø GKhuªch Trß½ng - 600026", 4, 600026 )
				AddNumText( sceneId, x805013_g_scriptId, "#GNhi®m vø GKhuªch Trß½ng - 600027", 4, 600027 )
			end
