...
x501000_g_PetDropList = {}
 ...
 -- π÷ŒÔ∫≈Œ™À˜“˝
 -- dropOdds: ≥ËŒÔµÙ¬‰¬ 
 -- petList –˙ngø…ƒ‹µÙ¬‰to’ µ ≥ËŒÔ¡–±Ì
 -- oddsList –˙ng petList ÷–œ‡”¶to’ µ ≥ËŒÔto’ µ µÙ¬‰»®÷ÿ
 
 -- doing 28833 by alan 2007.12.4
 -- ‘ –Ìmµt ÷÷π÷µÙ∂‡÷÷¿‡–Õto’ µ ≥Ë
 -- petTypeOdds –˙ng∏˜¿‡–Õto’ µ ≥Ëto’ µ µÙ¬‰»®÷ÿ,÷ª”–mµt ÷÷≥Ë ±≤ªC•n ÷∏∂®,¥À¡–±Ì÷–”–Nc·i÷µ ±,±ÿ–ÎÕ¨ ±÷∏∂®¥”petList2µΩpetListNto’ µ œ‡”¶≥ËŒÔ±Ì
 -- petList2 –˙ngµ⁄2÷÷¿‡–Õto’ µ ≥ËŒÔ¡–±Ì,ΩˆT’i petTypeOdds÷–”–2c·i“‘…œ÷µ ±∆◊˜”√
 -- petList3 –˙ngµ⁄3÷÷¿‡–Õto’ µ ≥ËŒÔ¡–±Ì,ΩˆT’i petTypeOdds÷–”–3c·i“‘…œ÷µ ±∆◊˜”√
 -- petListN –˙ngµ⁄N÷÷¿‡–Õto’ µ ≥ËŒÔ¡–±Ì,ΩˆT’i petTypeOdds÷–”–Nc·i“‘…œ÷µ ±∆◊˜”√
 
 --–ﬁ∏ƒ∫Û÷ª”–mµt ÷÷≥Ë ±∏Ò Ω”Î‘≠¿¥mµt —˘,œ¬√Ê–˙ng¡Ω÷÷≥Ëto’ µ ¿˝◊”: 
...
x501000_g_PetDropList[7980] = {
 dropOdds = 1471,
 petList = { 7980, 7989, 7988, 7987, 7986, 7985, 7984, 7983, 7982, 7981},
 oddsList = { 100000,25088,1254 },
}
...
function x501000_OnDie(sceneId, objId, killerId)
	...
	if not petDropInfo then      -- √ª”–’‚÷÷¿‡–Õto’ µ π÷ŒÔ≈‰÷√–≈œ¢
		return
	end
	
	local rand = random( x501000_g_RandNum )
	if rand > petDropInfo.dropOdds then   -- º∏¬ ≤ªπª,√ª”–≥ËŒÔµÙ¬‰
		return
	end

 	-- doing 28833 by alan 2007.12.4
 	-- –ﬁ∏ƒŒ™‘ –Ìmµt ÷÷π÷¥Ú≥ˆ∂‡÷÷¿‡–Õto’ µ ≥Ë
	...
	rand = random( rand )     -- ÷ÿ–¬Ω¯––mµt ¥ŒÀÊª˙,“‘≈–∂œ≥ˆƒƒ÷÷¿‡–Õto’ µ ≥ËŒÔ
