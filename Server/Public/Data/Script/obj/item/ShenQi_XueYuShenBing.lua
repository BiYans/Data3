...
x335134_g_CompoundInfo[980]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310064, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÏÄÁúÈ¸1
x335134_g_CompoundInfo[981]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310065, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÏÄÁúÈ¸2
x335134_g_CompoundInfo[982]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310066, },
	},
}
...
x335134_g_CompoundInfo[983]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310070, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÉÌ³¾Ó°1
x335134_g_CompoundInfo[984]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310071, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÉÌ³¾Ó°2
x335134_g_CompoundInfo[985]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310072, },
	},
}
...
x335134_g_CompoundInfo[986]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310073, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÖÜá°Ò¹1
x335134_g_CompoundInfo[987]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310074, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÖÜá°Ò¹2
x335134_g_CompoundInfo[988]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310075, },
	},
}
...
x335134_g_CompoundInfo[989]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310067, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÇØ·æïá1
x335134_g_CompoundInfo[990]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310068, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÇØ·æïá2
x335134_g_CompoundInfo[991]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310069, },
	},
}
...
x335134_g_CompoundInfo[992]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310079, },
	},
}
-- ÉñÆ÷Åä·½±í ´óºººë¸Ù1
x335134_g_CompoundInfo[993]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310080, },
	},
}
-- ÉñÆ÷Åä·½±í ´óºººë¸Ù2
x335134_g_CompoundInfo[994]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310081, },
	},
}
...
x335134_g_CompoundInfo[995]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310076, },
	},
}
-- ÉñÆ÷Åä·½±í ´ó½úĞÇºÛ1
x335134_g_CompoundInfo[996]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310077, },
	},
}
-- ÉñÆ÷Åä·½±í ´ó½úĞÇºÛ2
x335134_g_CompoundInfo[997]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310078, },
	},
}
...
x335134_g_CompoundInfo[998]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310082, },
	},
}
...
x335134_g_CompoundInfo[999]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310083, },
	},
}
-- ÉñÆ÷Åä·½±í ´óËåÄıËª2
x335134_g_CompoundInfo[1000]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310084, },
	},
}
...
x335134_g_CompoundInfo[1001]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310061, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÌÆÀ¥ÔÀ1
x335134_g_CompoundInfo[1002]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310062, },
	},
}
-- ÉñÆ÷Åä·½±í ´óÌÆÀ¥ÔÀ2
x335134_g_CompoundInfo[1003]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310063, },
	},
}
...
x335134_g_CompoundInfo[1004]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310085, },
	},
}
-- ÉñÆ÷Åä·½±í ´óËÎ¾ıá¯
x335134_g_CompoundInfo[1005]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310086, },
	},
}
-- ÉñÆ÷Åä·½±í ´óËÎ¾ıá¯
x335134_g_CompoundInfo[1006]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310087, },
	},
}
...
x335134_g_CompoundInfo[1115]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310088, },
	},
}
...
x335134_g_CompoundInfo[1116]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310089, },
	},
}
...
x335134_g_CompoundInfo[1117]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10310090, },
	},
}
----------------------------------------------------------------------------------------
-- ñÒÉÙÎ¢ 2008.5.22 Ìí¼Ó7ÖÖ102c¤pÉñÆ÷
