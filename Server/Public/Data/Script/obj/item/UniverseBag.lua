...
x300083_ItemList = {
	...
	{65,30504116}, --4
	{70,30504117}, --5
	{70,30504118}, --6 这个是补领的70级包
}
--modify by qds。 item :物品ID,num:给的物品数量，这里的都是不用程序进行绑定的。
x300083_GiftList = {}
x300083_GiftList[1]={{item=10101002,num=1},{item=10553090,num=1},{item=10553091,num=1},{item=10553092,num=1},{item=10553093,num=1},{item=10553094,num=1},{item=10553095,num=1},{item=10553096,num=1},{item=10553097,num=1},{item=10553098,num=1},{item=10553099,num=1},{item=10553100,num=1},{item=10553105,num=1}}
x300083_GiftList[2]={{item=10553203,num=1},{item=10553204,num=1},{item=10553205,num=1},{item=10553206,num=1},{item=10553207,num=2},{item=10553208,num=2},{item=10553209 ,num=1},{item=50313004,num=3},{item=31000004,num=2}}
...
x300083_BindGiftList[1]={{item=39910002,num=1},{item=39910002,num=1},{item=39910002,num=1}}
x300083_BindGiftList[2]={}
x300083_BindGiftList[3]={}
x300083_BindGiftList[4]={}
x300083_BindGiftList[5]={}
x300083_BindGiftList[6]={}
x300083_BindGiftList[7]={}
x300083_BindGiftList[8]={}
x300083_BindGiftList[9]={}
x300083_BindGiftList[10]={}
x300083_BindGiftList[11]={}
x300083_BindGiftList[12]={}
x300083_BindGiftList[13]={}
