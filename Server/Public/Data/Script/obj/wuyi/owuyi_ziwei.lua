...
function x032002_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
	AddText(sceneId,"  Chào m×ng các hÕ ðªn doanh trÕi tu¥n tra cüa ngß¶i S½n Vi®t. Các hÕ có th¬ ði lÕi kh¡p n½i · ðây, nhßng nh¤t ð×ng làm hÕi cây cö hoa lá · ðây, chúng là bÕn t¯t cüa ngß¶i S½n Vi®t.")
	AddText(sceneId,"  Phía bên kia là Thüy Tiên tÖ tÖ, tÖ ¤y là ngß¶i thông minh nh¤t trong doanh trÕi cüa chúng ta ð¤y.")
