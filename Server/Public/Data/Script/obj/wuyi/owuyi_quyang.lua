...
function x032001_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
	AddText(sceneId,"  Ch¸ em cüa bµ tµc S½n Vi®t r¤t ßu tú. #rTØ Vi d¸u dàng hi«n lành, m÷i ngß¶i ð«u thích. Thüy Tiên thanh t¸nh nhã nh£n, chín ch¡n thông minh, h½n næa Phù Dung tÖ tÖ.....")
