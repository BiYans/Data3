...
function x077011_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if val > x077011_g_PKMinVal then --[tx43640]Ô­Îª>= 5,Ó¦¸ÄÎª>x077011_g_PKMinVal,ÆäÊµÓ¦¸ÃÐúng[8,10]ÖÐtoÕ ðµ mµt cáiÖµ 
