...
function x808242_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if ret~= 1 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32471, 0 )
	end
	if ret~= 2 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32472, 0 )
	end
	if ret~= 3 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32473, 0 )
	end
	if ret~= 4 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32474, 0 )
	end
	LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32511, 0 )
...
-- 心法加成
--**********************************
function x808242_XinFaAddition( sceneId, selfId )
