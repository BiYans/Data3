--脚本号
x808229_g_scriptId = 808229

function x808229_OnImpactFadeOut( sceneId, selfId, impactId )
	if GetHp( sceneId, selfId ) == 0 then
		return		
	else
		--BroadMsgByChatPipe( sceneId, selfId, "Test5", 4 )
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 21768, 0 )		
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 21769, 0 )		
	end
end
...
-- 心法加成
--**********************************
function x808229_XinFaAddition( sceneId, selfId )
