...
function x808243_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if ret~= 1 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32475, 0 )
	end
	if ret~= 2 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32476, 0 )
	end
	if ret~= 3 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32477, 0 )
	end
	if ret~= 4 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32478, 0 )
	end
