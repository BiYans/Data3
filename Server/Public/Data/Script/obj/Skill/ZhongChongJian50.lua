...
function x808240_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if ret~= 1 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32463, 0 )
	end
	if ret~= 2 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32464, 0 )
	end
	if ret~= 3 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32465, 0 )
	end
	if ret~= 4 then
		LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32466, 0 )
	end
