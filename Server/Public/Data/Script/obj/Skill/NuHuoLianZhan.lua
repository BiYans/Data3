...
function x808233_OnImpactFadeOut( sceneId, selfId, impactId )
	if GetHp( sceneId, selfId ) == 0 then		
		...
		if LuaFnHaveImpactOfSpecificDataIndex(sceneId, selfId, 32430) == 1 then
			...
			elseif LuaFnHaveImpactOfSpecificDataIndex(sceneId, selfId, 32429) == 1 then
				...
				LuaFnCancelSpecificImpact(sceneId,selfId,32411)
				LuaFnCancelSpecificImpact(sceneId,selfId,32430)
			else
				LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 32415, 0 )
			end
		else
			LuaFnCancelSpecificImpact(sceneId,selfId,32411)
			LuaFnCancelSpecificImpact(sceneId,selfId,32413)
			for i = 32415, 32429 do
