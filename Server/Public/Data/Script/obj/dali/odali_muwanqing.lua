...
--Ğ¡°×ÍÃ¶ú¶äÊı¾İ±í....µÚ50»·Ê±C¥n ¸ÄËÍĞ¡°×ÍÃ¶ú¶ä....
  ...
  local PlayerName = GetName( sceneId, selfId )
	...
	BeginEvent( sceneId )
		...
		elseif IsMissionHaveDone( sceneId, selfId, x002010_g_ActivateMissionId ) > 0 then
			AddNumText( sceneId, x002010_g_scriptId, "#GNhi®m vø MUT - List 1", 3, 74131 )
			AddNumText( sceneId, x002010_g_scriptId, "#GNhi®m vø MUT - List 2", 3, 74132 )
			AddNumText( sceneId, x002010_g_scriptId, "#GNhi®m vø MUT - List 3", 3, 74133 )
			AddNumText( sceneId, x002010_g_scriptId, "#GNhi®m vø MUT - List 4", 3, 74134 )
...
function x002010_OnEventRequest( sceneId, selfId, targetId, eventId )
	if GetNumText() == 74131 then
		BeginEvent( sceneId )
			...
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038036", 3, 741311);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038037", 3, 741312);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038038", 3, 741313);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038039", 3, 741314);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038040", 3, 741315);
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	end
	...
	if GetNumText() == 74132 then
		BeginEvent( sceneId )
			...
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038020", 3, 741321);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038022", 3, 741322);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038024", 3, 741323);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038026", 3, 741324);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038028", 3, 741325);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038030", 3, 741326);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038032", 3, 741327);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038034", 3, 741328);
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	end
	...
	if GetNumText() == 74133 then
		BeginEvent( sceneId )
			...
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038021", 3, 741331);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038023", 3, 741332);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038025", 3, 741333);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038027", 3, 741334);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038029", 3, 741335);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038031", 3, 741336);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038033", 3, 741337);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1038035", 3, 741338);
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	end
	...
	if GetNumText() == 74134 then
		BeginEvent( sceneId )
			...
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010243", 3, 741343);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010244", 3, 741344);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010245", 3, 741345);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010246", 3, 741346);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010247", 3, 741347);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010248", 3, 741348);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010249", 3, 741349);
			AddNumText(sceneId, x002010_g_scriptId, "Nhi®m vø MUT - 1010250", 3, 741350);
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	end
	...
	if num == 1 then										-- Ä¾ÍñÇåÈÎÎñ
		...
		--local nDayTime = 	floor(nTime/100)	--ÉÏmµt ´Î½»ÈÎÎñtoÕ ğµ Ê±¼ä(ÌìÊı)
		local nDayTime = 	nTime								--ÉÏmµt ´Î½»ÈÎÎñtoÕ ğµ Ê±¼ä(ÌìÊı)
...
function x002010_OnModEvent_Submit(sceneId, selfId, targetId, missionIndex)
	...
	--Èç¹ûĞúngµÚ50»·(µÚmµt ´Î¸ø)....ÔòËÍÍæ¼Òmµt cáiĞ¡°×ÍÃ¶ú¶ä....·ñÔò¾ÍËÍÆÕÍ¨ÍÃ¶ú¶ä....
	if count == 50 then
