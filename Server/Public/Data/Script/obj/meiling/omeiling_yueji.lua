...
function x033009_UpdateEventList( sceneId, selfId, targetId )
	...
	local  PlayerName=GetName(sceneId,selfId)
		AddText(sceneId,"  G¥n ðây Thái Dß½ng Hoa tÖ tÖ r¤t hay n±i gi§n vô c¾, lÕ lùng th§t! Cûng chÆng biªt TØ Vi tÖ tÖ bên ðó có vi®c gì không, ðã lâu r°i không có tin tÑc gì cä.")
		AddText(sceneId,"  Cûng chÆng biªt Kinh Cúc ðang làm cái gì, m¤y hôm nay cäm giác r¤t n£ng n«, tña nhß s¡p có gì ðó xäy ra. Ôi, ch¡c là mình lÕi ða nghî r°i.")
