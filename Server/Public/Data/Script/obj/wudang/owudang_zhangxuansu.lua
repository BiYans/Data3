	...
	if GetNumText()==3	then
		...
		elseif GetLevel( sceneId, selfId ) < 10 then
			...
			elseif x012006_g_MenPai==9	then
				...
				-- °ÑÏà¹ØtoÕ ðµ ÐÄ·¨ÉèÖÃÎª10c¤p±ð  19,22,23
				...
				x012006_MsgBox( sceneId, selfId, "L¤y ðßþc 20 t¤m Chiêu t§p l®nh cüa môn phái" )

				if TryRecieveItem( sceneId, selfId, 10124004, 1 ) >= 0 then
					str		= "#YCác hÕ ðã nh§n ðßþc #W"..GetItemName( sceneId, 10124004 ).."."
