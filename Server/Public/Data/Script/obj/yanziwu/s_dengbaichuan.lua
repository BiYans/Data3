		...
		if GetName(sceneId, nNpcId)  == "Công Dã Càn" or
			...
			if selfId~= nNpcId  then
				...
				if GetHp(sceneId, nNpcId) > 100  then
					...
					CallScriptFunction((200060), "Paopao",sceneId, GetName(sceneId, nNpcId), "Yªn TØ ‘", "Tuy không sinh cùng tháng cùng nåm, nhßng nguy®n cùng tháng cùng nåm ð°ng nh¤t tØ!")
				end
			end
