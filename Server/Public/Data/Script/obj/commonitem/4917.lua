...
--		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, x334917_g_Impact1, 0);
		...
		if(0<=targetId) then
			if LuaFnIsFriend(sceneId, targetId, selfId) > 0 then
				...
				BeginEvent(sceneId)
			    AddText(sceneId, "Ğµ hão hæu ğã gia tång 500 ği¬m.");
			  EndEvent(sceneId)
			  DispatchMissionTips(sceneId,selfId)
			  
			  local	namSelf		= GetName( sceneId, selfId )
			  local	namTarget	= GetName( sceneId, targetId )
				local	str	= format( "#B#{_INFOUSR"..namSelf.."}#g7ffff0 tñ tay trao #g000000#W[99 Ğóa Hoa H°ng]#g7ffff0 ğªn #g000000#B#{_INFOUSR"..namTarget.."}#g7ffff0 n¾i dài tình nghîa v¾i #g000000#B#{_INFOUSR"..namTarget.."}#g7ffff0." )
