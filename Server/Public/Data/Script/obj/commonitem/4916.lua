...
function x334916_OnDeplete( sceneId, selfId )
	...
	if(LuaFnDepletingUsedItem(sceneId, selfId)) then
		...
		if itmId > 0 then
			...
			local	str	= format( "#B#{_INFOUSR"..namSelf.."}#cff0000 tñ tay ğem #W["..namItem.."]#cff0000 trao cho #B#{_INFOUSR"..namTarget.."}#cff0000 gia tång thâm tình v¾i #B#{_INFOUSR"..namTarget.."}#cff0000." )
...
--		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, x334916_g_Impact1, 0);
		...
		if(0<=targetId) then
			if LuaFnIsFriend(sceneId, targetId, selfId) > 0 then
				...
				BeginEvent(sceneId)
			    AddText(sceneId, "Ğµ häo hæu tång 50 ği¬m.");
			  EndEvent(sceneId)
