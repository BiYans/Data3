...
--½Å±¾ºÅ
x331001_g_scriptId = 331001 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x331001_g_Impact1 = 3003 --ÁÙÊ±Ğ´Cái này 
x331001_g_Impact2 = -1 --²»ÓÃ
x331001_g_SpecailObj = 1	--ÂşÌì»¨ÓêÌØĞ§
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
