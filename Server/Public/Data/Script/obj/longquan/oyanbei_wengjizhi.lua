...
function x031003_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
	AddText(sceneId,"  Khi trß¾c tu±i nhö không suy nghî, cÑ ngÞ chï c¥n thích là nên c¯ dành l¤y, chÆng h« nghî s¨ gây sai l¥m.")
	AddText(sceneId,"  Nh¸ ca vì tác thành cho ta mà phäi xu¤t gia, A Thanh vì nh¸ ca mà su¯t ð¶i thü ph§n, ta, ta, ta thñc là có tµi!")
