...
function x031004_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
	AddText(sceneId,"  Yêu ðß½ng ham mu¯n ngß¶i khác, thñc gi¯ng ðu¯c ði ngßþc gió, t¤t có cái h÷a böng tay. #rT× yêu t¤t sinh bu°n r¥u, có yêu t¤t sinh lo sþ, nªu r¶i xa yêu, còn gì ð¬ bu°n ð¬ sþ... #rThí chü có hi¬u chång?")
