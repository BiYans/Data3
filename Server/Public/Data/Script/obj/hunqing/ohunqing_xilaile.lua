...
x155000_g_eventId_leave = 1;		--ÎÒÒªÔÝÊ±³öÈ¥mµt ÏÂ
x155000_g_eventId_done = 2;			--¿ÉÒÔ¹Ø±ÕÀñÌÃÁË
x155000_g_eventId_redeem = 3;		--ÇëÌû¶mµt »ÀñÎï
...
x155000_g_redeemList = {{id=x155000_g_invitationDataId_level3, gemRate=10, moneyRate=90, money=300},
						{id=x155000_g_invitationDataId_level2, gemRate=20, moneyRate=80, money=150},
						{id=x155000_g_invitationDataId_level1, gemRate=10, moneyRate=90, money=100}}
...
function x155000_OnEventRequest(sceneId, selfId, targetId, eventId)
	...
	elseif eventId == x155000_g_eventId_done then	--Ôö¼ÓÈ·ÈÏÒ³,·ÀÖ¹Íæ¼Ò ði¬m´íÁË--modify by xindefeng		
		BeginEvent( sceneId )
	...
	elseif NumText == 101	then	-- ði¬m´íÁË,¹Ø±Õ¶Ô»°´°¿Ú
		BeginUICommand( sceneId )			
		EndUICommand( sceneId )
		DispatchUICommand( sceneId, selfId, 1000 )		
	end
