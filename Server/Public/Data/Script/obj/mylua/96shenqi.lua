...
function x210531_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x210531_g_ScriptId, "#G（#cFF0000神器炼魂#G）", 10, 100 )
		--AddNumText( sceneId, x210531_g_ScriptId, "#G（#cFF0000神器重炼#G）", 5, 200 )
		...
		AddNumText( sceneId, x210531_g_ScriptId, "下次再来", 9, 4 )
	EndEvent(sceneId)
...
function x210531_OnEventRequest( sceneId, selfId, targetId, eventId)
	if GetNumText() == 100 then
		BeginEvent( sceneId )
		      AddText( sceneId, "#c0066ff神兵符#W可以在#Y燕子副本#W获得!" )
			...
			AddNumText( sceneId, x210531_g_scriptId, "#G（#cFF0000开始炼化#G）", 10, 101)
			AddNumText( sceneId, x210531_g_scriptId, "#G（#cFF0000武器升级#G）", 10, 102)
			AddNumText( sceneId, x210531_g_scriptId, "#G（#cFF0000开始重炼#G）", 10, 103)
	...
	elseif GetNumText() == 101 then
		BeginEvent( sceneId )
			...
			AddNumText( sceneId, x210531_g_scriptId, "#G赤焰九纹刀#G", 10, 1011)
			AddNumText( sceneId, x210531_g_scriptId, "#G斩忧断愁枪#G", 10, 1012)
			AddNumText( sceneId, x210531_g_scriptId, "#G弈天破邪杖#G", 10, 1013)
			AddNumText( sceneId, x210531_g_scriptId, "#G含光弄影剑#G", 10, 1014)
			AddNumText( sceneId, x210531_g_scriptId, "#G万仞龙渊剑#G", 10, 1015)
			AddNumText( sceneId, x210531_g_scriptId, "#G转魂灭魄钩#G", 10, 1016)
			AddNumText( sceneId, x210531_g_scriptId, "#G雷鸣离火扇#G", 10, 1017)
			AddNumText( sceneId, x210531_g_scriptId, "#G碎情雾影环#G", 10, 1018)
			AddNumText( sceneId, x210531_g_scriptId, "#G天星耀阳环#G", 10, 1019)
			AddNumText( sceneId, x210531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 1011 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10300005,1)--删除物品
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10300005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553124, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10300005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553129, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1014 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10302005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553134, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10302005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553139, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1016 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10304005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553149, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10304005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553154, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1018 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10305005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553159, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10305005,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553164, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器炼化成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1022 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553124,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553125, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1023 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553129,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553130, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1024 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553134,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553135, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1025 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553139,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553140, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1026 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553149,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553150, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1027 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553154,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553155, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1028 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553159,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553160, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30505817,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553165, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器重炼成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 103 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#G你确定要重炼吗？" )
			AddNumText( sceneId, x210531_g_scriptId, "#G赤焰九纹刀#G", 10, 1031)
			AddNumText( sceneId, x210531_g_scriptId, "#G斩忧断愁枪#G", 10, 1032)
			AddNumText( sceneId, x210531_g_scriptId, "#G弈天破邪杖#G", 10, 1033)
			AddNumText( sceneId, x210531_g_scriptId, "#G含光弄影剑#G", 10, 1034)
			AddNumText( sceneId, x210531_g_scriptId, "#G万仞龙渊剑#G", 10, 1035)
			AddNumText( sceneId, x210531_g_scriptId, "#G转魂灭魄钩#G", 10, 1036)
			AddNumText( sceneId, x210531_g_scriptId, "#G雷鸣离火扇#G", 10, 1037)
			AddNumText( sceneId, x210531_g_scriptId, "#G碎情雾影环#G", 10, 1038)
			AddNumText( sceneId, x210531_g_scriptId, "#G天星耀阳环#G", 10, 1039)
			AddNumText( sceneId, x210531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 1032 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553125,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553125, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
	...
	elseif GetNumText() == 1033 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553130,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553130, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
	...
	elseif GetNumText() == 1034 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553135,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553135, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
	...
	elseif GetNumText() == 1035 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553140,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553140, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
	...
	elseif GetNumText() == 1036 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553150,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553150, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
	...
	elseif GetNumText() == 1037 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553155,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553155, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
	...
	elseif GetNumText() == 1038 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553160,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553160, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10553165,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10553165, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
