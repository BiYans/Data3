...
--事件交互入口
--**********************************
function x510531_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x510531_g_ScriptId, "#G（#cFF0000进入平台#G）", 10, 100 )
		AddNumText( sceneId, x510531_g_ScriptId, "下次再来", 9, 4 )
	EndEvent(sceneId)
...
--事件列表选中一项
--**********************************
function x510531_OnEventRequest( sceneId, selfId, targetId, eventId)
	if GetNumText() == 100 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#G（#cFF0000神器附体#G）" )
		       AddText( sceneId, "#cff99ff提示（#G请拆下已镶嵌的宝石#cff99ff）" )
			AddNumText( sceneId, x510531_g_scriptId, "#G（#cFF0000106神器兑换#G）", 10, 101)
			AddNumText( sceneId, x510531_g_scriptId, "#G（#cFF0000106神器加星#G）", 10, 102)
			AddNumText( sceneId, x510531_g_scriptId, "#G（#cFF0000106神器附体#G）", 10, 103)
                     AddNumText( sceneId, x510531_g_scriptId, "#G（#cFF0000106重炼神器#G）", 10, 107)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 101 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#cff99ff神器精魄#W50#cff99ff个" )
		      AddText( sceneId, "#G你确定要兑换吗？" )
			AddNumText( sceneId, x510531_g_scriptId, "#G赤焰九纹刀", 10, 1011)
			AddNumText( sceneId, x510531_g_scriptId, "#G斩忧断愁枪", 10, 1012)
			AddNumText( sceneId, x510531_g_scriptId, "#G弈天破邪杖", 10, 1013)
			AddNumText( sceneId, x510531_g_scriptId, "#G含光弄影剑", 10, 1014)
			AddNumText( sceneId, x510531_g_scriptId, "#G万仞龙渊剑", 10, 1015)
			AddNumText( sceneId, x510531_g_scriptId, "#G星移无痕剑", 10, 1016)
			AddNumText( sceneId, x510531_g_scriptId, "#G转魂灭魄钩", 10, 1017)
			AddNumText( sceneId, x510531_g_scriptId, "#G雷鸣离火扇", 10, 1018)
			AddNumText( sceneId, x510531_g_scriptId, "#G碎情雾影环", 10, 1019)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环", 10, 1020)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 1011 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555116, 1)--给予物品
	...
	elseif GetNumText() == 1012 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555121, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1013 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555126, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1014 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555131, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1015 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555136, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1016 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555141, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1017 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555146, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1018 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555151, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1019 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555156, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1020 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c1 >=50 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,20310118,50)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555161, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，兑换神器成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 102 then
		BeginEvent( sceneId )
			...
			AddNumText( sceneId, x510531_g_scriptId, "#G赤焰九纹刀 - 升9星", 10, 1021)
			AddNumText( sceneId, x510531_g_scriptId, "#G斩忧断愁枪 - 升9星", 10, 1022)
			AddNumText( sceneId, x510531_g_scriptId, "#G弈天破邪杖 - 升9星", 10, 1023)
			AddNumText( sceneId, x510531_g_scriptId, "#G含光弄影剑 - 升9星", 10, 1024)
			AddNumText( sceneId, x510531_g_scriptId, "#G万仞龙渊剑 - 升9星", 10, 1025)
			AddNumText( sceneId, x510531_g_scriptId, "#G星移无痕剑 - 升9星", 10, 1026)
			AddNumText( sceneId, x510531_g_scriptId, "#G转魂灭魄钩 - 升9星", 10, 1027)
			AddNumText( sceneId, x510531_g_scriptId, "#G雷鸣离火扇 - 升9星", 10, 1028)
			AddNumText( sceneId, x510531_g_scriptId, "#G碎情雾影环 - 升9星", 10, 1029)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 升9星", 10, 1030)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )

	elseif GetNumText() == 1021 then
                     local nStoneId0 = 10555116
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555116,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555117, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1022 then
                     local nStoneId0 = 10555121
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555121,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555122, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1023 then
                     local nStoneId0 = 10555126
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555126,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555127, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1024 then
                     local nStoneId0 = 10555131
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555131,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555132, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1025 then
                     local nStoneId0 = 10555136
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555136,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555137, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1026 then
                     local nStoneId0 = 10555141
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555141,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555142, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1027 then
                     local nStoneId0 = 10555146
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555146,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555147, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1028 then
                     local nStoneId0 = 10555151
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555151,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555152, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1029 then
                     local nStoneId0 = 10555156
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555156,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555157, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 1030 then
                     local nStoneId0 = 10555161
	       	local nStoneId1 = 20310118
              c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
                                  LuaFnDelAvailableItem(sceneId,selfId,10555161,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310118,20)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10555162, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
					x210531_ShowRandomSystemNotice( sceneId, selfId, szItemTransfer )
					strText = "#G恭喜你，神器加星成功！"
					AddText( sceneId, strText )
	...
	elseif GetNumText() == 103 then
		BeginEvent( sceneId )
			...
			AddNumText( sceneId, x510531_g_scriptId, "#G熔炼龙附体", 10, 104)
			AddNumText( sceneId, x510531_g_scriptId, "#G熔炼凤附体", 10, 105)
			AddNumText( sceneId, x510531_g_scriptId, "#G熔炼蝶附体", 10, 106)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
       ...
       elseif GetNumText() == 104 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#cff99ff神兵符#W20#cff99ff个" )
		      AddText( sceneId, "#G请先摘除神器上的宝石，以免造成损失！" )
			AddNumText( sceneId, x510531_g_scriptId, "#G赤焰九纹刀 - 龙附体", 10, 1041)
			AddNumText( sceneId, x510531_g_scriptId, "#G斩忧断愁枪 - 龙附体", 10, 1042)
			AddNumText( sceneId, x510531_g_scriptId, "#G弈天破邪杖 - 龙附体", 10, 1043)
			AddNumText( sceneId, x510531_g_scriptId, "#G含光弄影剑 - 龙附体", 10, 1044)
			AddNumText( sceneId, x510531_g_scriptId, "#G万仞龙渊剑 - 龙附体", 10, 1045)
			AddNumText( sceneId, x510531_g_scriptId, "#G星移无痕剑 - 龙附体", 10, 1046)
			AddNumText( sceneId, x510531_g_scriptId, "#G转魂灭魄钩 - 龙附体", 10, 1047)
			AddNumText( sceneId, x510531_g_scriptId, "#G雷鸣离火扇 - 龙附体", 10, 1048)
			AddNumText( sceneId, x510531_g_scriptId, "#G碎情雾影环 - 龙附体", 10, 1049)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 龙附体", 10, 1050)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 1050 then
       ...
       elseif GetNumText() == 105 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#cff99ff神兵符#W20#cff99ff个" )
		      AddText( sceneId, "#G请先摘除神器上的宝石，以免造成损失！" )
			AddNumText( sceneId, x510531_g_scriptId, "#G赤焰九纹刀 - 凤附体", 10, 1051)
			AddNumText( sceneId, x510531_g_scriptId, "#G斩忧断愁枪 - 凤附体", 10, 1052)
			AddNumText( sceneId, x510531_g_scriptId, "#G弈天破邪杖 - 凤附体", 10, 1053)
			AddNumText( sceneId, x510531_g_scriptId, "#G含光弄影剑 - 凤附体", 10, 1054)
			AddNumText( sceneId, x510531_g_scriptId, "#G万仞龙渊剑 - 凤附体", 10, 1055)
			AddNumText( sceneId, x510531_g_scriptId, "#G星移无痕剑 - 凤附体", 10, 1056)
			AddNumText( sceneId, x510531_g_scriptId, "#G转魂灭魄钩 - 凤附体", 10, 1057)
			AddNumText( sceneId, x510531_g_scriptId, "#G雷鸣离火扇 - 凤附体", 10, 1058)
			AddNumText( sceneId, x510531_g_scriptId, "#G碎情雾影环 - 凤附体", 10, 1059)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 凤附体", 10, 1060)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 1060 then
       ...
       elseif GetNumText() == 106 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#cff99ff神兵符#W20#cff99ff个" )
		      AddText( sceneId, "#G请先摘除神器上的宝石，以免造成损失！" )
			AddNumText( sceneId, x510531_g_scriptId, "#G赤焰九纹刀 - 蝶附体", 10, 1061)
			AddNumText( sceneId, x510531_g_scriptId, "#G斩忧断愁枪 - 蝶附体", 10, 1062)
			AddNumText( sceneId, x510531_g_scriptId, "#G弈天破邪杖 - 蝶附体", 10, 1063)
			AddNumText( sceneId, x510531_g_scriptId, "#G含光弄影剑 - 蝶附体", 10, 1064)
			AddNumText( sceneId, x510531_g_scriptId, "#G万仞龙渊剑 - 蝶附体", 10, 1065)
			AddNumText( sceneId, x510531_g_scriptId, "#G星移无痕剑 - 蝶附体", 10, 1066)
			AddNumText( sceneId, x510531_g_scriptId, "#G转魂灭魄钩 - 蝶附体", 10, 1067)
			AddNumText( sceneId, x510531_g_scriptId, "#G雷鸣离火扇 - 蝶附体", 10, 1068)
			AddNumText( sceneId, x510531_g_scriptId, "#G碎情雾影环 - 蝶附体", 10, 1069)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 蝶附体", 10, 1070)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText() == 1070 then
		...
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#cff99ff神兵符#W20#cff99ff个" )
		      AddText( sceneId, "#G请先摘除神器上的宝石，以免造成损失！" )
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 龙附体", 10, 1071)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 凤附体", 10, 1072)
			AddNumText( sceneId, x510531_g_scriptId, "#G天星耀阳环 - 蝶附体", 10, 1073)
			AddNumText( sceneId, x510531_g_scriptId, "取消", 9, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
