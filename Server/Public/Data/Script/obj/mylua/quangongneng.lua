	...
	elseif GetNumText() == 8512 then
      ...
      elseif GetNumText() == 104 then
       ...
       elseif GetNumText() == 501 then
		...
		AddNumText( sceneId, x889062_g_ScriptId, "免费-哥想把马子#gff00f0(称号)",7,210 )
		...
		AddNumText( sceneId, x889062_g_ScriptId, "免费-这个世界哪里有爱情#gff00f0(称号)",7,17 )
		...
		AddNumText( sceneId, x889062_g_ScriptId, "免费-我是新手！别杀我！#gff00f0(称号)",7,203 )
		AddNumText( sceneId, x889062_g_ScriptId, "免费-我是老大#gff00f0(称号)",7,204 )
		AddNumText( sceneId, x889062_g_ScriptId, "免费-别装B！装B遭雷劈！#gff00f0(称号)",7,205 )
		AddNumText( sceneId, x889062_g_ScriptId, "免费-散人！不打架！#gff00f0(称号)",7,206 )
		AddNumText( sceneId, x889062_g_ScriptId, "免费-对不起！我爱你！#gff00f0(称号)",7,207 )
		AddNumText( sceneId, x889062_g_ScriptId, "免费-请不要离开我#gff00f0(称号)",7,208 )
    	EndEvent( sceneId )
	DispatchEventList( sceneId, selfId, targetId )
