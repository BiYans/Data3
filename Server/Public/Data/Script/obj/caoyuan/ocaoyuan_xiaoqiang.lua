...
function x020003_UpdateEventList( sceneId, selfId,targetId )
	...
	--Íê³É¡°Linh»êtoÕ ðµ ºô»½¡±ÈÎÎñÖ®ºó
	if IsStepDone4 == 1 then
		AddText(sceneId,"  "..PlayerName.."#{OBJ_caoyuan_0004}")
	--Ã»ÓÐÍê³É¡°¿¤Ö÷toÕ ðµ ÃüÁî¡±¡¢¡°Âí·ËÊ×Áì¡±¡¢¡°Ó¢ÐÛtoÕ ðµ Ö¤Ã÷¡±ÈÎÎñÖ®Ç°
	elseif IsStepDone1 == 0 and IsStepDone2 == 0 and IsStepDone3 == 0 then
		AddText(sceneId,"  Ngß½i chính là "..PlayerName.." ? #rCa ca t× #G NhÕn B¡c#W gØi thß t¾i nói ngß½i là 1 anh hùng, kêu ta tiªp ðãi tØ tª. Nhßng ta th¤y ngß½i không gi¯ng 1 anh hùng")
	--Íê³É¡°Linh»êtoÕ ðµ ºô»½¡±ÈÎÎñÖ®Ç°
	else
