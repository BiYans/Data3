...
function x027004_UpdateEventList( sceneId, selfId,targetId )
	...
	local  PlayerName=GetName(sceneId,selfId)
		AddText(sceneId,"  TÕi sao ðôi thanh mai trúc mã t× nhö sau khi trß·ng thành cÑ nh¤t ð¸nh phäi s¯ng bên nhau? #rTa th¤y th§t khó hi¬u. TÕi sao m÷i ngß¶i ð«u cho r¢ng nhß v§y là..., ta có nên cÑu A Thi Mã không? Nàng là bÕn hæu t¯t nh¤t, nhßng...")
		AddText(sceneId,"  TÕi sao? TÕi sao? Ngay cä A Y Na ð«u cho r¢ng ta và A Thi Mã là ðôi kim ð°ng ng÷c næ?")
