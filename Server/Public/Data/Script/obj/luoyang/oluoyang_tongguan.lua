...
function x000004_UpdateEventList( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
	local  PlayerName=GetName(sceneId,selfId)
	AddText(sceneId,"  "..PlayerName..PlayerSex.."th¤y các hÕ th§t vui m×ng! Ta hi®n gi¶ phø trách công vi®c cüa cuµc thi Túc C¥u. Cuµc thi túc c¥u b¡t ð¥u vào 19h t¯i chü nh§t ðªn 23h kªt thÑc. C½ hµi hiªm có, ð×ng bö lÞ!");
