...
function x025002_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"  Ðây là Quan Nguy®t Ðình · Thß½ng S½n, phía trß¾c chính là Nhî Häi, vào m²i ðêm trång, Nhî Häi phong ðình nß¾c tînh, ánh trång sáng vàng v£c hòa trong m£t h°, nhß ngàn vÕn vì sao l¤p lánh, muôn ngàn con sóng bÕc lån tån.");
	AddText(sceneId,"  Vách núi ð¯i di®n là V÷ng Tuyªt Nhai, ðÑng trên vách núi ðó có th¬ nhìn th¤y tuyªt tr¡ng trên ðïnh Tang S½n. Tuyªt tr¡ng phau phau nhß khoác chiªc áo tr¡ng tinh, dß¾i ánh m£t tr¶i chiªu r÷i, tr¡ng sáng long lanh.");
	AddText(sceneId,"  Cänh ð©p nhß v§y mà ðã lâu mà sao không có ai dám t¾i thß·ng thÑc..");
