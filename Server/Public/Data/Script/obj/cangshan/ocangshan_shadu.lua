...
function x025001_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"  H×! Chï c¥n ta có m£t, không ai ðßþc ðøng t¾i Tát Tang ðÕi nhân! #rTên m§p thúi Tát L² kia nªu ngß½i dám xông vào, t¾i 1 ta giªt 1, t¾i 2 ta giªt 2!");
