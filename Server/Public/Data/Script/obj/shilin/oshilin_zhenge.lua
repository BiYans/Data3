...
function x026004_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"Dù xäy ra b¤t kÏ chuy®n gì, ta vçn không tin tß¾ng công ta lÕi biªn thành Y¬n sß, ông là ngß¶i ta yêu quý nh¤t, cûng là ngß¶i thân duy nh¤t cüa ta trên thª gian này, nh¤t ð¸nh ông có n±i kh± tâm, nh¤t ð¸nh v§y.")
	AddText(sceneId,"T¤t cä ð«u do l²i cüa lû Y¬n sß, t¤t cä là do l²i cüa chúng!")
