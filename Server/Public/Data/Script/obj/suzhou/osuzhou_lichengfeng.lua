...
x001028_g_Impact_NotTransportList = { 5929, 5944 } -- ½ûÖ¹´«ËÍtoÕ ðµ Impact
x001028_g_TalkInfo_NotTransportList = { "#{GodFire_Info_062}", "#{XSHCD_20080418_099}" } -- ½ûÖ¹´«ËÍtoÕ ðµ ImpactÌáÊ¾ÐÅÏ¢
...
function x001028_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x001028_g_ScriptId, "#GThành Th¸ - Phøng Minh Tr¤n", 9, 1013 )
		--AddNumText( sceneId, x001028_g_ScriptId, "Tam Xuân Huy«n Cänh", 9, 1016 )
...
function x001028_OnEventRequest( sceneId, selfId, targetId, eventId )
  ...
  if arg == 1007 then		--Lâu Lan
	...
	if arg == 1016 then		--»Ã¾³
		BeginEvent( sceneId )
			AddText( sceneId, "  Ê®¶þÉ·ÐÇ¸±±¾ÉúËÀÀÞÌ¨ÖÆ×÷ÖÐ. " )
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
