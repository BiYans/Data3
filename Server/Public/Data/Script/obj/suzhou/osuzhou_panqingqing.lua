...
function x001090_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"Ð« ngh¸ t± ðµi nên có Thiên S½n. Bên trong giáo ð¥u có sÑc mÕnh phi thß¶ng lþi hÕi, c¥n sØ døng kÛ nång Qu¥n th¬ tàng hình Th§p Di®n Mai Phøc tàng hình m¾i có th¬ qua.")

	AddNumText( sceneId, x001090_g_scriptId, "V« TÑ Tuy®t Trang",0 ,2  )
...
function x001090_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	BeginEvent(sceneId)
	    AddText(sceneId,"TÑ Tuy®t Trang phø bän chü yªu r½i xu¯ng Long Vån. M²i ngày 3 lßþt, sau khi giªt chªt Boss · màn cu¯i s¨ th¤y mµt cái TÑ Tuy®t Trang Bäo Sß½ng.#r#YChú ý: KÛ nång cüa Boss cñc kÏ lþi hÕi. C¦n th§n nha. Ð« ngh¸ ðªn c¤p b§c thích hþp m¾i tham gia phø bän.")
	EndEvent(sceneId)
	DispatchEventList(sceneId,selfId,targetId)
		return
	end
