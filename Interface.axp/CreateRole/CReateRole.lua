...
function CreateRole_ShowRoleFace(iType)
	...
	if(0 == iType) then
		...
		g_iCurFaceCount = GameProduceLogin:GetWomanFaceCount();--GetWomanFaceCountForCreate();

	elseif(1 == iType) then

		g_iCurFaceCount = GameProduceLogin:GetManFaceCount();--GetManFaceCountForCreate();
