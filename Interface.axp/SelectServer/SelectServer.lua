...
-- ¹«²âÇøÓò°´Å¥µÄ¸öÊý
local LOGIN_SERVER_TESTAREA_COUNT = 8;
-- ÇøÓò°´Å¥
local g_BnArea = {};
...
function LoginSelectServer_OnLoad()
  ...
  --
	...
	SelectServer_Help_Text5:SetText(	strNormalColor.."#e010101#c4CFA4CXanh: Cñc t¯t#cffffff" );
...
--    GameProduceLogin:StartAccountReg()
  GameProduceLogin:OpenURL( "https://psp.gate.vn/Account/SignUp/?f=tl" )
end
