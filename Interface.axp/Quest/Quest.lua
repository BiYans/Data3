...
function Quest_EventListUpdate()
	...
	for i=1, nEventListNum do
		...
		elseif(strType == "id") then
			if strState <= 0 or strState > 14 then
				strState = 8
			end
...
function OpenUrl( )
	GameProduceLogin:OpenURL( "http://www.cyou.com/User/Reg/invite" )
end
--µã»÷±¦±´»Ø¼Ò¼Æ»®Á´½Ó
function OpenUrl_BBHJ()
	GameProduceLogin:OpenURL("http://www.baobeihuijia.com/About.aspx");
end