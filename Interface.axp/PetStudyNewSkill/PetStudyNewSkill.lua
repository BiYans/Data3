...
function PetStudyNewSkill_OnUICommand()
  ...
  PetStudyNewSkill_SkillType_Text:SetText("#gFF0FA0DÕy trân thú kÛ nång m¾i")
...
function PetStudyNewSkill_Show()
	...
	g_selfrm = ""
	g_pidx = -1
	--Èç¹ûÕâÀï²»½«g_stduySkillÖØÖÃ£¬ÄÇÃ´ÔÚÑ§Ï°ÁËÒ»´Î¼¼ÄÜÖ®ºó£¬ÔÙ¸Ä±äÕäÊÞ×´Ì¬£¬½«²»»áÇå¿Õui
	--ÀíÂÛÉÏÄ³¸ö±äÁ¿µÄÊ¹ÓÃÒ²Ó¦¸ÃÊÇÒ»¸öÑ­»·À´µÄ
	--ÕâÀï¼ÌÐøÊ¹ÓÃtrue false°É£¬¸úÕâ¸öÎÄ¼þµÄ·ç¸ñÒ»ÖÂ
	g_stduySkill = false
