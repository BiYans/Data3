...
function WuhunSkillUp_LoadSkill()
	...
	if WuhunAuthor ~= "No_Author" then
		local VoHon_Skill1 = string.sub(WuhunAuthor,48,50);
		...
		local VoHon_Skill2 = string.sub(WuhunAuthor,51,53);
		...
		local VoHon_Skill3 = string.sub(WuhunAuthor,54,56);
...
function WuhunSkillUp_OnEvent(event)
	if (event == "UI_COMMAND" and tonumber(arg0) == 263001) then
