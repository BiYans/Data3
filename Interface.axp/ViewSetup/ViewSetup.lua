...
function ViewSetup_OnLoad()
		...
		CHECK_CTRL[7]  = ViewSetup_Item_Miwu;			-- ÏÔÊ¾ÃÔÎí
		CHECK_CTRL[8]  = ViewSetup_Item_Bantou;		-- ÕÚµ²°ëÍ¸
		...
		SLIDER_String[11]  = "txdjsz"	--ÌØÐ§µÈ¼¶ÉèÖÃ
		SLIDER_String[12]  = "dhgxzl"	--¶¯»­¸üÐÂÖÊÁ¿
...
function ViewSetup_Default_Clicked()
	...
	SystemSetup:View_SetData( SLIDER_String[11], 2 );	--ÌØÐ§µÈ¼¶ÉèÖÃ
	SystemSetup:View_SetData( SLIDER_String[12], 2 );	--¶¯»­¸üÐÂÖÊÁ¿
	...
	SystemSetup:View_SetData( CHECK_String[8],0 );	--ÕÚµ²°ëÍ¸
